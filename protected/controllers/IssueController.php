...
class IssueController extends Controller
{
	 ...
	 */
	// Implemented in the base class components/Contrller.php
	/*
	...
	*/
	...
	public function actionCreate()
	{
		...
		// provide project_id for the form input
	 ...
	 * @param integer projectId the primary identifier of the primary identifier of the associated Project
	...
	public function filterProjectContext($filterChain)
	{
		...
		// Complete the running of the other filter and execute the requested action
		$filterChain->run();
	}
