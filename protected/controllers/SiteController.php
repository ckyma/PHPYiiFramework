...
class SiteController extends Controller
{
	...
	// override the default action to be login
	...
	public function actionLogin()
	{
		...
		// redirect logged in user to home url
		...
		// error when set 'language' = 'rev' in config/mian.php, so added here as an alternative
	...
	/**
	 * Test the logging function using CVarDumper::dump(Yii::getLogger()->getLogs());
	 */
