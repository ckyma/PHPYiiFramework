...
class Issue extends TrackStarActiveRecord
{
	...
	/**
	 * Retrives a list of issue types
	...
	/**
	 * Retrives a list of allowed issue values
	 * @return array an array of alowed issue values
	 */
	...
	/**
	 * Retrives a list of allowed status values
	 * @return array an array of alowed status values
	 */
