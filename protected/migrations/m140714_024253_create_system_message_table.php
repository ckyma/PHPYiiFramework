...
class m140714_024253_create_system_message_table extends CDbMigration
{
	public function up()
	{
		...
		//the tbl_sys_message.create_user_id is a reference to tbl_user.id
		$this->addForeignKey("fk_sys_message_owner", "tbl_sys_message", "create_user_id", "tbl_user", "id", "CASCADE", "RESTRICT");
		
		//the tbl_sys_message.update_user_id is a reference to tbl_user.id
