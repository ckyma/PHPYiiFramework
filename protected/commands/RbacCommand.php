...
class RbacCommand extends CConsoleCommand
{
	...
	// Override the getHelp() of base for the more help info
	...
	/**
	 * The default action - create RBAC structure
	 */
	public function actionIndex()
	{
		$this->ensureAuthManagerDefined();
		
		// proivide the opportunity for the use to abort the request
		$message = "This command will create three roles: Owner, Member, Reader and Admin\n";
		...
		if($this->confirm($message))
		{
			...
			//ensure we have one admin in the system (force it to be user id #7, which is username 'admin')
